...
public class CartUserAdapter extends RecyclerView.Adapter<CartUserAdapter.viewholder> {
    ...
    public CartUserAdapter(ArrayList<Article> items, ArrayList<Customize>itemsCustomize , Context context, ManagementCart managementCart, Runnable emptyStateChecker) {
        this.items = items;
    ...
    @NonNull
    @Override
    public CartUserAdapter.viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder_list_user_cart, parent, false);

        return new viewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CartUserAdapter.viewholder holder, int position) {
